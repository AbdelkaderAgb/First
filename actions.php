...
if (isset($_SESSION['user'])) {
    ...
    if ($u['role'] == 'admin') {
        ...
        if (isset($_POST['admin_add_order'])) {
            ...
            if (empty($address)) {
                $pickup_name = ($lang == 'ar' && isset($zones[$pickup_zone])) ? (is_array($zones[$pickup_zone]) ? $zones[$pickup_zone]['ar'] : $zones[$pickup_zone]) : (isset($zones[$pickup_zone]) && is_array($zones[$pickup_zone]) ? $zones[$pickup_zone][$lang] : $pickup_zone);
                $dropoff_name = ($lang == 'ar' && isset($zones[$dropoff_zone])) ? (is_array($zones[$dropoff_zone]) ? $zones[$dropoff_zone]['ar'] : $zones[$dropoff_zone]) : (isset($zones[$dropoff_zone]) && is_array($zones[$dropoff_zone]) ? $zones[$dropoff_zone][$lang] : $dropoff_zone);
