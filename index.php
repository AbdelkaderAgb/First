                            ...
                            <div class="list-group list-group-flush">
                                ...
                                <div class="list-group-item d-flex align-items-center justify-content-between px-0 border-0">
                                    <div class="d-flex align-items-center gap-2">
                                        ...
                                        <span><?php echo isset($zones[$zone['pickup_zone']]) ? e($zones[$zone['pickup_zone']]) : e($zone['pickup_zone']); ?></span>
                                    </div>
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-12">
                                <div class="d-flex flex-wrap gap-2 align-items-center">
                                    ...
                                    <span class="badge bg-primary"><?php echo isset($zones[$zone]) ? e($zones[$zone]) : e($zone); ?></span>
                                    <?php endforeach; ?>
                        ...
                        <div class="order-zone-info mb-3">
                            <div class="d-flex align-items-center justify-content-between p-2 bg-light rounded">
                                <div class="text-center flex-grow-1">
                                    ...
                                    <span class="small fw-bold"><?php echo isset($zones[$pickupZone]) ? $zones[$pickupZone] : e($pickupZone); ?></span>
                                </div>
                                <div class="px-2">
                                ...
                                <div class="text-center flex-grow-1">
                                    ...
                                    <span class="small fw-bold"><?php echo isset($zones[$dropoffZone]) ? $zones[$dropoffZone] : e($dropoffZone); ?></span>
                                </div>
                            </div>
                        </div>
                        <?php endif; ?>
