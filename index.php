                            ...
                            <div class="list-group list-group-flush">
                                ...
                                <div class="list-group-item d-flex align-items-center justify-content-between px-0 border-0">
                                    <div class="d-flex align-items-center gap-2">
                                        ...
                                        <span><?php echo ($lang == 'ar' && isset($zones[$zone['pickup_zone']])) ? (is_array($zones[$zone['pickup_zone']]) ? e($zones[$zone['pickup_zone']]['ar']) : e($zones[$zone['pickup_zone']])) : (isset($zones[$zone['pickup_zone']]) && is_array($zones[$zone['pickup_zone']]) ? e($zones[$zone['pickup_zone']][$lang]) : e($zone['pickup_zone'])); ?></span>
                                    </div>
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-12">
                                <div class="d-flex flex-wrap gap-2 align-items-center">
                                    ...
                                    <span class="badge bg-primary"><?php echo ($lang == 'ar' && isset($zones[$zone])) ? (is_array($zones[$zone]) ? e($zones[$zone]['ar']) : e($zones[$zone])) : (isset($zones[$zone]) && is_array($zones[$zone]) ? e($zones[$zone][$lang]) : e($zone)); ?></span>
                                    <?php endforeach; ?>
                            ...
                            <div class="row mb-3">
                                <div class="col-6">
                                    ...
                                    <select name="pickup_zone" id="pickupZone" class="form-select" required onchange="calculateDeliveryPrice()">
                                        <option value=""><?php echo $t['select_zone'] ?? 'Select zone'; ?></option>
                                        <?php foreach($zones as $key => $name): ?>
                                        <option value="<?php echo e($key); ?>"><?php echo is_array($name) ? $name[$lang] : (($lang == 'ar') ? $name : $key); ?></option>
                                        <?php endforeach; ?>
                                    </select>
                                </div>
                                <div class="col-6">
                        ...
                        <div class="order-zone-info mb-3">
                            <div class="d-flex align-items-center justify-content-between p-2 bg-light rounded">
                                <div class="text-center flex-grow-1">
                                    ...
                                    <span class="small fw-bold"><?php echo ($lang == 'ar' && isset($zones[$pickupZone])) ? (is_array($zones[$pickupZone]) ? $zones[$pickupZone]['ar'] : $zones[$pickupZone]) : (isset($zones[$pickupZone]) && is_array($zones[$pickupZone]) ? $zones[$pickupZone][$lang] : e($pickupZone)); ?></span>
                                </div>
                                <div class="px-2">
                                ...
                                <div class="text-center flex-grow-1">
                                    ...
                                    <span class="small fw-bold"><?php echo ($lang == 'ar' && isset($zones[$dropoffZone])) ? (is_array($zones[$dropoffZone]) ? $zones[$dropoffZone]['ar'] : $zones[$dropoffZone]) : (isset($zones[$dropoffZone]) && is_array($zones[$dropoffZone]) ? $zones[$dropoffZone][$lang] : e($dropoffZone)); ?></span>
                                </div>
                            </div>
                        </div>
                        <?php endif; ?>
